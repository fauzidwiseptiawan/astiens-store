                        ...
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.html">
                                    <img class="svgInject" alt="Evara"
                                        src="{{ asset('template/frontend') }}/imgs/theme/icons/icon-heart.svg">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="shop-cart.html">
                                    <img alt="Evara"
                                        src="{{ asset('template/frontend') }}/imgs/theme/icons/icon-cart.svg">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara"
                                                        src="{{ asset('template/frontend') }}/imgs/shop/thumbnail-3.jpg"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara"
                                                        src="{{ asset('template/frontend') }}/imgs/shop/thumbnail-2.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{ asset('template/frontend') }}/imgs/banner/menu-banner-2.jpg"
                                                        alt="menu_banner1">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="{{ asset('template/frontend') }}/imgs/banner/menu-banner-3.jpg"
                                                        alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{ asset('template/frontend') }}/imgs/banner/menu-banner-4.jpg"
                                                        alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{ asset('template/frontend') }}/imgs/banner/menu-banner-5.jpg"
                                                        alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                                ...
                                                <div class="header-banner2">
                                                    <img src="{{ asset('template/frontend') }}/imgs/banner/menu-banner-6.jpg"
                                                        alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul>
                                ...
                                <li class="position-static"><a href="#">Categories <i
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="shop-product-right.html"><img
                                                        src="{{ asset('template/frontend') }}/imgs/banner/menu-banner.jpg"
                                                        alt="Evara"></a>
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Evara"
                                                    src="{{ asset('template/frontend') }}/imgs/shop/thumbnail-4.jpg"></a>
                                        </div>
                                        <div class="shopping-cart-title">
    ...
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-social-icon">
                ...
                <a href="#"><img src="{{ asset('template/frontend') }}/imgs/theme/icons/icon-facebook.svg"
                        alt=""></a>
                <a href="#"><img src="{{ asset('template/frontend') }}/imgs/theme/icons/icon-twitter.svg"
                        alt=""></a>
                <a href="#"><img src="{{ asset('template/frontend') }}/imgs/theme/icons/icon-instagram.svg"
                        alt=""></a>
                <a href="#"><img src="{{ asset('template/frontend') }}/imgs/theme/icons/icon-pinterest.svg"
                        alt=""></a>
                <a href="#"><img src="{{ asset('template/frontend') }}/imgs/theme/icons/icon-youtube.svg"
                        alt=""></a>
            </div>
        </div>
    </div>
