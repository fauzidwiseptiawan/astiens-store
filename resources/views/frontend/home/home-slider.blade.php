        ...
        <div class="row">
                            ...
                            <div class="container">
                                <div class="slider-1-height-3 slider-animated-1">
                                    ...
                                    <div class="slider-img">
                                        <img src="{{ asset('template/frontend') }}/imgs/slider/slider-4.png"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-hero-slider single-animation-wrap">
                            <div class="container">
                                <div class="slider-1-height-3 slider-animated-1">
                                    ...
                                    <div class="slider-img">
                                        <img src="{{ asset('template/frontend') }}/imgs/slider/slider-5.png"
                                            alt="">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-3 d-md-none d-lg-block">
                <div class="banner-img banner-1 wow fadeIn  animated home-3">
                    <img class="border-radius-10" src="{{ asset('template/frontend') }}/imgs/banner/banner-5.jpg"
                        alt="">
                ...
                <div class="banner-img banner-2 wow fadeIn  animated mb-0">
                    <img class="border-radius-10" src="{{ asset('template/frontend') }}/imgs/banner/banner-7.jpg"
                        alt="">
                    <div class="banner-text">
