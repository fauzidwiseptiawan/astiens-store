    ...
    <section class="pt-25 pb-20">
        <div class="container wow fadeIn animated">
            <h3 class="section-title mb-20"><span>Best</span> Selling</h3>
            <div class="carausel-5-columns-cover position-relative">
                <div class="slider-arrow slider-arrow-2 carausel-5-columns-arrow" id="carausel-5-columns-2-arrows">
                </div>
                <div class="carausel-5-columns carausel-arrow-center" id="carausel-5-columns-2">
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="shop-product-right.html">
                                    <img class="default-img"
                                        src="{{ asset('template/frontend') }}/imgs/shop/product-2-1.jpg" alt="">
                                    <img class="hover-img"
                                        src="{{ asset('template/frontend') }}/imgs/shop/product-2-2.jpg" alt="">
                                </a>
                            </div>
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="shop-product-right.html">
                                    <img class="default-img"
                                        src="{{ asset('template/frontend') }}/imgs/shop/product-4-1.jpg" alt="">
                                    <img class="hover-img"
                                        src="{{ asset('template/frontend') }}/imgs/shop/product-4-2.jpg" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal"
